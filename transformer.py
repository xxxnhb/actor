...
text = clip.tokenize(["A man is warming up", "A man is walking", "A man is running", "A man is jumping", "A man is drinking", "A man is lifting dumbbell", "A man is siting", "A man is eating", "A man is turning steering wheel", "A man is putting a phone call", "A man is boxing", "A man is throwing"]).to(device)
